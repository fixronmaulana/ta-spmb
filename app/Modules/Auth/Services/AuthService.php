...
class AuthService
{
    ...
    /**
     * Generate token, simpan ke DB, kirim email reset password.
     * Selalu return success=true agar tidak bocorkan info apakah email terdaftar.
     */
    public function forgotPassword(string $email): array
    {
        ...
        if (! $sent) {
            ...
            // Tetap return pesan generik agar tidak bocor
        }
    ...
    /**
     * Verifikasi token, update password (di-hash otomatis oleh UserModel::beforeUpdate).
     */
    public function resetPassword(string $token, string $password): array
    {
        ...
        // Update password — UserModel::hashPassword() akan otomatis bcrypt
    ...
    /**
     * Kirim email OTP verifikasi akun
     */
    ...
    /**
     * Template HTML email OTP verifikasi
     */
