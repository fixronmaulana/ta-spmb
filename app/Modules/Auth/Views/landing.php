        ...
        <div class="grid md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div class="card-elevated p-6 lg:p-8">
                ...
                <ul class="space-y-2">
                    <?php
                    $majorList = [
                        ['code' => 'TKJ',  'name' => 'Teknik Komputer dan Jaringan',          'icon' => '💻'],
                        ['code' => 'AK',   'name' => 'Akuntansi dan Keuangan Lembaga',         'icon' => '📊'],
                        ['code' => 'DKV',  'name' => 'Desain Komunikasi Visual',               'icon' => '🎨'],
                        ['code' => 'ATU',  'name' => 'Agribisnis Ternak Unggas',               'icon' => '🐔'],
                        ['code' => 'DPIB', 'name' => 'Desain Pemodelan dan Informasi Bangunan', 'icon' => '🏗️'],
                    ];
