        ...
        <div class="konten">
            ...
            <table class="info-tbl">
                ...
                <tr>
                    ...
                    <td class="val">: <?= esc($siswa->jurusan_nama) ?></td>
                </tr>
                <tr>
                    <td class="lbl">Kelas</td>
                    <td class="val">: <?= esc($siswa->kelas_nama ?? '-') ?></td>
                </tr>
                <tr>
                    <td class="lbl">Tahun Masuk</td>
                    <td class="val">: <?= esc($siswa->tahun_masuk ?? '-') ?></td>
                </tr>
            </table>
            <div class="k-footer">
...
<?php else: /* ===== MODE BUKU INDUK (default) ===== */ ?>
   ...
   ───────────────────────────────────────────────────────────── */
        ...
        .penempatan-tbl tr:nth-child(even) td {
            background: #f9fafb;
        }

        .penempatan-tbl td.no {
            width: 34px;
        }
    ...
    <body>
        ...
        <div class="clearfix">
            ...
            <table class="data-tbl">
                ...
                $itemA = [
                    ...
                    [10, 'Anak Ke',                     '-'],
                    [11, 'Status dalam Keluarga',       esc($dash($siswa->dds_status_anak))],
                ];
        ...
        <table class="data-tbl">
            ...
            $itemE = [
                ...
                [25, 'Alamat Sekolah Asal', esc($dash($siswa->dds_alamat_sekolah))],
        ...
        <div class="ttd-wrap">
            ...
            <div class="ttd-right">
                <div class="ttd-kota">Banyuwangi, <?= esc($tglTtd ?? date('j F Y')) ?></div>
                <div class="ttd-jabatan">Kepala Sekolah,</div>
                <div class="ttd-garis"><?= esc($siswa->kepala_sekolah_nama ?? 'Kepala Sekolah') ?></div>
